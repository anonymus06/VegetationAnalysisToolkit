...
calculate_and_print_feedback <- function(all_data, filtered_data, output, variable, env) {
  ...
  script_name <- "calculate_and_print_feedback.R"

  project_header_summary <- generate_project_header(summary_file_name, summary_file_content, script_name)
  project_header_detailed <- generate_project_header(detailed_file_name, detailed_file_content, script_name)
